...
export default function HomePageSlider({ options }) {
    return (     
        <Slider {...options}>
          <article>
            <img src="https://firebasestorage.googleapis.com/v0/b/eksamens-projekt-d596b.appspot.com/o/slider%2Fexample1.webp?alt=media&token=44671e7e-a74c-4b01-887a-3236c9baffb3" alt="img01" />
          </article>
          <article>
            <img
